...
public class ConsumerSampleWithGroups {
    private static final Logger logger = LoggerFactory.getLogger(ConsumerSampleWithGroups.class);

    private static String bootstrapServer = "localhost:9092";
    private static String groupId = "kafka_samples2";  // kafka-console-consumer.sh --bootstrap-server localhost:9092 --topic first_topic --group kafka_samples
